...
# make up cmd="crawl guardian --channel CHANNEL --url-template 'https://www.theguardian.com/world/live/2022/%s/%d/russia-ukraine-latest-news-missile-strikes-on-oil-facilities-reported-as-some-russian-banks-cut-off-from-swift-system-live'"
