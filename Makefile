...
# make up cmd="crawl guardian --channel CHANNEL --url-template 'russia-ukraine-latest-news-missile-strikes-on-oil-facilities-reported-as-some-russian-banks-cut-off-from-swift-system-live'"
